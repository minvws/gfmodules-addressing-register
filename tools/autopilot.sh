...
echo "📖 This script will help you running the addressing service for the first time. It will try to setup everything"
...
docker compose up addressing_db -d
...
docker compose run app ./tools/migrate_db.sh addressing_db postgres postgres postgres
...
echo "🏁 Autopilot completed. You should be able to go to your web browser and access the application at http://localhost:8501/docs."
