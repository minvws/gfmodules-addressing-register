...
INSERT INTO public.addresses (provider_id, data_domain, endpoint, request_type, parameters) VALUES ('huisarts.apeldoorn@medmij', 'test resultant', 'https://huisarts.services.nl', 'GET', '[{"name": "category", "type" : "string", "value" : "blood-tests", "required": "true", "description": "blood test results"}, {"name": "test-type", "type" : "string", "values": ["liver function", "thyroid function"], "required": "true", "description": "the type of the blood work done"}]');