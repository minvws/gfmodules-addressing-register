...
def test_delete_one_also_deletes_managing_org_reference(
    endpoint_service: EndpointService,
    organization_service: OrganizationService,
    setup_postgres_database: Database,
) -> None:
...
def test_update_one_correctly_updates_endpoint_with_managing_org(
    endpoint_service: EndpointService,
    organization_service: OrganizationService,
    setup_postgres_database: Database,
) -> None:
    ...
    old_endpoint = add_endpoint(endpoint_service, complete_endpoint=expected.copy())
    assert (
        endpoint_service.get_one(old_endpoint.fhir_id).data.get(  # type: ignore
