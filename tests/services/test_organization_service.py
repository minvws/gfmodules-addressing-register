...
from tests.utils import add_organization, add_endpoint


def test_get_one_correctly_finds_organization(organization_service: OrganizationService,
...
def test_get_one_fails_correctly_when_no_organization_is_found(organization_service: OrganizationService,
                                                               setup_postgres_database: Database) -> None:
    setup_postgres_database.truncate_tables()
...
def test_add_one_correctly_adds_organization(organization_service: OrganizationService,
                                             setup_postgres_database: Database) -> None:
    setup_postgres_database.truncate_tables()
    dg = DataGenerator()
...
def test_add_one_fails_correctly_when_endpoint_does_not_exist(organization_service: OrganizationService,
                                                              setup_postgres_database: Database) -> None:
    setup_postgres_database.truncate_tables()
...
def test_add_one_fails_correctly_with_invalid_resource(organization_service: OrganizationService,
    ...
    test_org.identifier = [Identifier.construct(system="http://fhir.nl/fhir/NamingSystem/ura", # type: ignore
                                                value="abc")]
...
def test_delete_one_correctly_deletes_organization(organization_service: OrganizationService,
                                                   setup_postgres_database: Database) -> None:
    setup_postgres_database.truncate_tables()
...
def test_update_one_correctly_updates_organization(organization_service: OrganizationService,
                                                   setup_postgres_database: Database) -> None:
    setup_postgres_database.truncate_tables()
...
def test_update_one_correctly_adds_endpoint_to_organization(organization_service: OrganizationService,
                                                            endpoint_service: EndpointService,
                                                            setup_postgres_database: Database) -> None:
    setup_postgres_database.truncate_tables()
...
def test_update_one_correctly_fails_when_endpoint_is_not_found(organization_service: OrganizationService, setup_postgres_database: Database) -> None:
    setup_postgres_database.truncate_tables()
    old_org = add_organization(organization_service)
    fhir_new_org = FhirOrganization(**old_org.data) # type: ignore
