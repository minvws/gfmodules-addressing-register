...
def test_validate_reference_healthcare_service_valid(
    ...
    session.execute.return_value.first.return_value = HealthcareService(
        fhir_id="6b74c461-b19c-4860-b819-708997bb6b86"
    )

    data = Reference.construct(
        reference="HealthcareService/6b74c461-b19c-4860-b819-708997bb6b86"
    )
...
def test_validate_reference_organization_affiliation_invalid(
    ...
    data = Reference.construct(
        reference="OrganizationAffiliation/c4f768a6-9190-4555-8c7d-ea577671515f"
    )
...
def test_validate_reference_invalid_reference_type(
    ...
    data = Reference.construct(
        reference="InvalidType/6b74c461-b19c-4860-b819-708997bb6b86"
    )
...
def test_validate_list_of_same_typed_references(
    ...
    session.execute.side_effect = [
        MagicMock(
            first=Mock(
                return_value=HealthcareService(
                    fhir_id="6b74c461-b19c-4860-b819-708997bb6b86"
                )
            )
        ),
        MagicMock(
            first=Mock(
                return_value=HealthcareService(
                    fhir_id="c4f768a6-9190-4555-8c7d-ea577671515f"
                )
            )
        ),
    ]
    ...
    data = [
        ...
        Reference.construct(
            reference="HealthcareService/c4f768a6-9190-4555-8c7d-ea577671515f"
        ),
    ]
